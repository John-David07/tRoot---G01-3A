...
class _AiRecommendationsWidgetState extends State<AiRecommendationsWidget> {
  ...
  Future<void> _recordToHistoryIfNeeded(
    String sensorId,
    int moisture,
    double temp,
    double humidity,
  ...
  Future<void> _loadRecommendations() async {
    ...
    if (_cacheService.hasAiCache(
      currentMoisture,
      currentTemp,
      currentHumidity,
    )) {
      final cachedRecs = _cacheService.getAiCache(
        currentMoisture,
        currentTemp,
        currentHumidity,
      )!;
      ...
      await _recordToHistoryIfNeeded(
        sensorId,
        currentMoisture,
        currentTemp,
        currentHumidity,
